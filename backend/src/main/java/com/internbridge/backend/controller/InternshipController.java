...
public class InternshipController {
    ...
    @PostMapping
    public ResponseEntity<InternshipResponseDTO> createInternship(@Valid @RequestBody InternshipRequestDTO requestDTO) {
        return ResponseEntity.ok(internshipService.createInternship(requestDTO));
    }
    ...
    public ResponseEntity<List<InternshipResponseDTO>> getInternshipsByCompanyId(@PathVariable UUID companyId) {
        return ResponseEntity.ok(internshipService.getInternshipsByCompanyId(companyId));
    }

    @PutMapping("/{id}")
    public ResponseEntity<InternshipResponseDTO> updateInternship(@PathVariable UUID id, @Valid @RequestBody InternshipRequestDTO requestDTO) {
